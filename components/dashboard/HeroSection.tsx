...
export function HeroSection({ xp = 50000, streak = 45 }: { xp?: number; streak?: number }) {
  return (
    <div className="bg-surface-container p-6 md:p-8 relative overflow-hidden flex flex-col justify-between border-l-8 border-tertiary-fixed shadow-lg h-full">
      ...
      <div className="z-10">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <span className="font-headline font-bold text-on-surface-variant uppercase tracking-widest text-sm">Tier 01 Active</span>
        </div>
      </div>
      
      <div className="grid grid-cols-2 gap-4 md:gap-8 mt-10 md:mt-12 z-10">
        <div>
          <div className="font-headline font-bold uppercase text-[10px] text-on-surface-variant tracking-widest mb-1">TOTAL POINTS BALANCE</div>
